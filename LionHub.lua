...
local Togglejip = Tabs.st:AddToggle("Auto observation", { Title = "Cày điểm observation [ World 3 only ]", Default = false })
...
local Kiemcho = Tabs.item:AddSection("Trident Sw")
...
local oioioi = Tabs.item:AddSection("Zoro Sw")

local Toggleoni = Tabs.item:AddToggle("Toggle Hop", {Title = "Buy Zoro Sw",Description = "", Default = false })
...
local Cacbu = Tabs.item:AddSection("Cavander Sw")
...
local Toggle = Tabs.item:AddToggle("Auto kill player", { Title = "Kill Player nhiệm vụ elite", Default = false })
Toggle:OnChanged(function(Value)
...
local Nit = Tabs.item:AddSection("Tushita Và câu chuyện Rip_indra")

local Togglehb = Tabs.item:AddToggle("auto Kill", { Title = "Gắn Haki",  Default = false })
...
local Toggle = Tabs.item:AddToggle("auto Kill", { Title = "Gắn đuốc hay s t quên rồi",  Default = false })
Toggle:OnChanged(function(Value)
...
Tabs.Misc:AddSection("Tầm bậy tầm bạ")
