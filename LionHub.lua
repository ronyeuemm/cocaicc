...
ImageButton.Image = "rbxassetid://131351843186068"
	...
	function library:Window(text,text2,text3,logo,keybind)
		...
		function uitab:T(text,logo1)
			...
			function main:Button(text,callback)
				...
				IMGBUTTON.Image = "http://www.roblox.com/asset/?id=131351843186068"
		...
		function main:Dropdown(text,option,callback)
			...
			DropImage.Image = "rbxassetid://131351843186068"
...
local win = library:Window("Lion",[[Hub]],[[Version : Beta  ]],"131351843186068",Enum.KeyCode.RightControl)
...
local Hop = win:T("Hop",[[9608089732]])
...
spawn(function()
        while wait() do
            if _G.AutoObservation or _G.Kill_V4 or _G.Auto_Kill_Ply == true then
                pcall(function()
...
spawn(
    ...
    while wait() do
        spawn(
            ...
            or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
                Elite:Set("Boss spawn")	
            else
                Elite:Set("Boss Not Found")	
            end
        end
        )
    end
 ...
 function updateMirageStatus()
    ...
    if mirageIsland then
        Mirage:Set('Status: Mirage spawm')
    else
        Mirage:Set('Status: Mirage Not Found')
    end
end
...
spawn(function()
    ...
    Main:Toggle("Auto Bones", false, function(value)
        _G.Auto_Bone = value
...
Quest:Toggle("Auto Sea Beast For Fist Of Darkness", false, function(Vu)
_G.Auto_Seabest = Vu
end)
...
Quest:Button("test", function()
TPP(CFrame.new(-16927.451171875, 9.0863618850708, 433.8642883300781)) 
end)
